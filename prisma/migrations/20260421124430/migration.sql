-- CreateTable
CREATE TABLE "user_event_store" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "userEventId" TEXT NOT NULL,
    "payload" TEXT NOT NULL,
    "createdAt" TEXT NOT NULL DEFAULT (strftime('%Y-%m-%dT%H:%M:%SZ', 'now')),
    "updatedAt" TEXT NOT NULL DEFAULT (strftime('%Y-%m-%dT%H:%M:%SZ', 'now')),
    CONSTRAINT "user_event_store_userEventId_fkey" FOREIGN KEY ("userEventId") REFERENCES "user_event" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
INSERT INTO "new_user_event" ("completedAt", "createdAt", "eventId", "id", "startedAt", "updatedAt", "userId") SELECT "completedAt", "createdAt", "eventId", "id", "startedAt", "updatedAt", "userId" FROM "user_event";
...
-- CreateIndex
CREATE UNIQUE INDEX "user_event_store_userEventId_key" ON "user_event_store"("userEventId");
